...
class DetalleServicioController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('DetalleServicio');
	...
	{
		$model=new DetalleServicio('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['DetalleServicio']))
			$model->attributes=$_GET['DetalleServicio'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='detalle-servicio-form')
		{
